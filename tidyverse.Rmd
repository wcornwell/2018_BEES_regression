...
* All data is not tidy, but most can be
* A tidy dataframe has: 1 observation per row, 1 variable per column

## You want to one of two things with data
...
Untidy data %>% tidy data %>% plots and analysis
...
* Not always good with Japanese characters
